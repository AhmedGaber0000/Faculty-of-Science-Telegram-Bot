...
// Construct derived variables from your config.php
$API_URL = 'https://api.telegram.org/bot' . $BOT_TOKEN . '/';

// For local XAMPP testing, the log file can be in the same directory
// For Vercel, it MUST be '/tmp/bot_activity.log'
define('LOG_FILE', __DIR__ . '/bot_activity.log');


// ===================================================================
// 2. ALL FUNCTION DEFINITIONS
// All of your functions must be defined here, before any are called.
// ===================================================================
...
function startWebhook() {
    global $NG_URL; // Get the webhook URL from your config.php

    logActivity("Attempting to set webhook to: " . $NG_URL);
    $response_json = apiRequest("setWebhook", ['url' => $NG_URL]);
...
// ===================================================================
// 3. MAIN SCRIPT LOGIC (The part that runs)
// ===================================================================

// --- Admin Action Handler ---
// First, check if the admin is trying to perform a setup action.
